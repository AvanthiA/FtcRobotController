...
public class AutoOpsBlueWarehouse extends LinearOpMode {
    ...
    private void first(){
        ...
        //move backward so parallel to shipping hub
        Trajectory backward = drive.trajectoryBuilder(strafeRight.end())
                .back(25)
                .build();
        ...
        Trajectory strafeLeft = drive.trajectoryBuilder(backward.end())
                .strafeLeft(20.5)
                .build();
        ...
        //move forward 45 inches so in warehouse
        Trajectory forward = drive.trajectoryBuilder(strafeLeft.end())
                .forward(65)
                .build();
        ...
        strafeRight = drive.trajectoryBuilder(forward.end())
                .strafeRight(25)
                .build();
        drive.followTrajectory(strafeRight);
        strafeRight.end();
           ...
           if (tfod != null) {
                ...
                if (updatedRecognitions != null) {
                    ...
                    for (Recognition recognition : updatedRecognitions) {
                        ...
                        if(recognition.getLabel().equals("Duck") && left>260 && left<340&& top>70 && top<150 &&right>350 && right<440 && bottom>160 && bottom<240){
                            position = "first";
                            break;
                        }
                        if(recognition.getLabel().equals("Duck") && left>0 && left<80&& top>60 && top<140 &&right>80 && right<160 && bottom>130 && bottom<220){
                            position = "second";
                            break;
                        }
                        i++;
